...
\begin{homeworkProblem}
  ...
  \begin{enumerate}[(a)]
    ...
    \]
    \item Final average error on training: 0.047378.

    $l_2$ norm of weights: 0.773330
    \begin{figure}
      \centering
      \includegraphics[width=.65\textwidth]{figures/error_2b_eta1}
      \caption{Average loss for $\eta=0.001$ using vanilla SGD} 
    \end{figure}
