...
\newcommand{\hmwkDueDate}{May 1, 2017}
...
I collaborated with Weston Barger and Emily Dinan throughout the assignment.
...
\begin{homeworkProblem}
  ...
  If we assume that $A$ and $B$ are independent events then we have $\Pr(A\wedge B)=\Pr(A)\Pr(B)$. It follows that 
  \[
    \Pr(A\wedge B)=\Pr(A)\Pr(B)\leq\left(2e^{-(\epsilon^2-\epsilon^3)m/4} \right)^2=4e^{-(\epsilon^2-\epsilon^3)m/2}\leq 4e^{-(\epsilon^2-\epsilon^3)m/4}.
  \]
